...
const (
	...
	ipv6NetAdst = "3008:DB8::1"
	ipv6NetBdst = "3009:DB9::1"
)
...
func configureDUT(t *testing.T, dut *ondatra.DUTDevice) {
	...
	ni100 := &oc.NetworkInstance{Name: ygot.String(vrf100Name), Type: oc.NetworkInstanceTypes_NETWORK_INSTANCE_TYPE_L3VRF}
	gnmi.Replace(t, dut, gnmi.OC().NetworkInstance(vrf100Name).Config(), ni100)

	if deviations.ExplicitInterfaceInDefaultVRF(dut) {
		fptest.AssignToNetworkInstance(t, dut, p1.Name(), vrf100Name, 0)
	...
	t.Log("Applying policies initially to port2 and port3")
...
func configurePBFPolicy(t *testing.T, dut *ondatra.DUTDevice) {
	...
	r10.GetOrCreateIpv4().SetSourceAddress("0.0.0.0/0")
	r10.GetOrCreateIpv4().SetDestinationAddress("0.0.0.0/0")
	...
	r20.GetOrCreateIpv6().SetSourceAddress("::/0")
	// TODO: Add destination address once the <bug id> is fixed.
